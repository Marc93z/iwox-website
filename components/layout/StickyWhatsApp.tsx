...
export default function StickyWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-40 flex items-center gap-3 px-4 py-3 bg-whatsapp hover:bg-whatsapp-dark text-white rounded-full shadow-glow-wa hover:-translate-y-0.5 transition-all group"
    >
      ...
      <span className="hidden sm:block text-sm font-semibold whitespace-nowrap">{t('sticky.whatsapp')}</span>
    </a>
  );
}
